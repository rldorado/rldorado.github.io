...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ti,depthTest:!1,depthWrite:!1})}function pc(){return new si({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:hl(),fragmentShader:`
		...
		`,blending:ti,depthTest:!1,depthWrite:!1})}function mc(){return new si({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:hl(),fragmentShader:`
